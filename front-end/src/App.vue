  ...
  <div id="app">
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark small">
      <a class="navbar-brand mr-5" href="#">
        <img src="@/assets/Test2/star-icon.png" alt="" width="30" height="24" />
        Seok</a
      >
      <button
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <router-link to="/complainss" class="dropdown-item">
                Complain
              </router-link>
            </div>
          </li>
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <router-link to="/freeboards" class="dropdown-item">
                자유게시판 목록
              </router-link>
              <router-link to="/add-freeboard" class="dropdown-item">
                글쓰기
              </router-link>
            </div>
          </li>
          ...
          <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <router-link to="/faqboards" class="dropdown-item">
                FAQ 목록
              </router-link>
              <router-link to="/add-faqboard" class="dropdown-item">
                글쓰기
              </router-link>
            </div>
          </li>
